...
TopDirRelpathLockDB::TopDirRelpathLockDB(const string& db_location_base)
...
bool TopDirRelpathLockDB::Track(const string& top_dir) {
...
leveldb::DB* TopDirRelpathLockDB::GetTopDirDB(const string& top_dir) {
