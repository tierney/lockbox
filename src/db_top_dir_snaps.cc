...
TopDirSnapsDB::TopDirSnapsDB(const string& db_location_base)
...
bool TopDirSnapsDB::Track(const string& top_dir) {
...
leveldb::DB* TopDirSnapsDB::GetTopDirDB(const string& top_dir) {
